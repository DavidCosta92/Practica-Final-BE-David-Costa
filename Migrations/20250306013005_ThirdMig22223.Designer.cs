...
namespace FinalProjectBakary.Migrations
{
    ...
    [Migration("20250306013005_ThirdMig22223")]
    partial class ThirdMig22223
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BreadMenu", b =>
                {
                    b.Property<int>("AvailableBreadsId")
                        .HasColumnType("integer");

                    b.Property<int>("MenuId")
                        .HasColumnType("integer");

                    b.HasKey("AvailableBreadsId", "MenuId");
            ...
            modelBuilder.Entity("BreadMenu", b =>
                {
                    b.HasOne("FinalProjectBakary.Domain.Entities.Breads.Bread", null)
                        .WithMany()
                        .HasForeignKey("AvailableBreadsId")
            ...
            modelBuilder.Entity("FinalProjectBakary.Domain.Entities.Office", b =>
                {
                    b.HasOne("FinalProjectBakary.Domain.Entities.Menu", "Menu")
                        .WithMany()
                        .HasForeignKey("MenuId");
